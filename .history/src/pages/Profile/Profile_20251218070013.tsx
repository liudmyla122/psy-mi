      ...
      <main className="profile-main">
        <div className="profile-container">
          ...
          <div className="profile-top-section">
            <div className="profile-top-left">
              ...
              <div className="profile-greeting-section">
                ...
                <p className="profile-consultation-text">
                  <span className="profile-consultation-highlight">Якщо Ви хочете отримати додаткову консультацію від нашого психолога</span> <span className="profile-consultation-rest">щодо результатів, залиште свій контакт в будь-якому месенджері - ми з вами зв'яжемось.</span>
                </p>
                <div className="profile-contact-input-wrapper" style={{ display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'nowrap' }}>
                  <input
                    type="text"
                  ...
                  >
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M18.3334 1.66666L9.16669 10.8333M18.3334 1.66666L12.5001 18.3333L9.16669 10.8333M18.3334 1.66666L1.66669 7.49999L9.16669 10.8333" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </button>
                  {showMessengers && contactInput.trim() && (
                    <div className="profile-messengers-wrapper" style={{
                      display: 'flex',
                      gap: '12px',
                      alignItems: 'center',
                      flexShrink: 0
                  ...
                  <button
                    ...
                    style={{
                      ...
                      height: '40px',
                      borderRadius: '50%',
                      border: selectedMessenger === 'telegram' ? '2px solid #347AEC' : '2px solid transparent',
                  ...
                  <button
                    ...
                    style={{
                      ...
                      height: '40px',
                      borderRadius: '50%',
                      border: selectedMessenger === 'instagram' ? '2px solid #347AEC' : '2px solid transparent',
                  ...
                  <button
                    ...
                    style={{
                      ...
                      height: '40px',
                      borderRadius: '50%',
                      border: selectedMessenger === 'facebook' ? '2px solid #347AEC' : '2px solid transparent',
                  ...
                  <button
                    ...
                    style={{
                      ...
                      height: '40px',
                      borderRadius: '50%',
                      border: selectedMessenger === 'linkedin' ? '2px solid #347AEC' : '2px solid transparent',
            ...
            <button
              type="button"
              className="profile-logout-button-top"
                ...
                <div className="profile-test-results-list">
                  {enneagramResults.map((result) => (
                    <div key={result.id} className="profile-test-result-row">
                      ...
                      <span className="profile-test-result-date">{formatDate(result.completedAt)}</span>
                      <span 
                        className="profile-test-details-link"
                        onClick={() => navigate(getTestPath(result.testType), { 
                          state: { 
