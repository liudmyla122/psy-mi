          ...
          <section className="enneagram-intro-section">
            ...
            <div className="enneagram-description">
              <p>
                ...
                які керують нами на
                <br /> підсвідомому рівні.
              </p>
            </div>
          </section>

          {/* Секция с роботом и диаграммой */}
          <section className="enneagram-robot-section">
          ...
          <section className="enneagram-question-section-wrapper">
            <div className="enneagram-header">
              ...
              <div className="enneagram-counter">
                <span>
                  Питання {currentQuestion + 1} / {generalQuestions} (
                  {Math.round(((currentQuestion + 1) / generalQuestions) * 100)}%)
                </span>
                <div
                  className="enneagram-progress-bar"
                  style={{ width: `${((currentQuestion + 1) / generalQuestions) * 100}%` }}
                />
              </div>
            </div>
